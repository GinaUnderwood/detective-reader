...
function bind(){
  document.querySelectorAll('[data-view]').forEach(x=>x.onclick=()=>{stopNarration();if(state.view==='lesson'&&state.screen===11)resetScreenEleven();state.view=x.dataset.view;render()});
